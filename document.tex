...
\abstract{ A head-mounted wireless gaze tracker in the form of gaze tracking glasses is used for continuous and mobile
monitoring of a subject's point of regard on the surrounding 3D environment. We combined gaze tracking and hand gesture recognition to allow a subject to interact with objects in the environment by gazing at them, and controlling the object
using hand gesture commands. The gaze tracking glasses was made from low-cost hardware consisting of a safety glasses'
frame and wireless eye tracking and scene cameras. An open source gaze estimation algorithm is used for eye tracking and user's
...
these elements the emerging system permits a subject to move freely in an environment, select the object they want to
